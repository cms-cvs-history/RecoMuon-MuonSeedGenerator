#ifndef RecoMuon_SeedGeneratorTest_H
#define RecoMuon_SeedGeneratorTest_H
...
#include "SeedGeneratorHistograms.h"
#include "SeedGeneratorNtuple.h"
...
class SeedGeneratorTest : public edm::EDAnalyzer {
public:

  /// Constructor
  SeedGeneratorTest(const edm::ParameterSet& pset);

  /// Destructor
  virtual ~SeedGeneratorTest();
