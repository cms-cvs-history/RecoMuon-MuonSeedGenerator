#ifndef RecoMuon_SeedParametrization_H
#define RecoMuon_SeedParametrization_H
...
#include "SeedParameterHisto.h"
#include "SeedParameterNtuple.h"
...
class SeedParametrization : public edm::EDAnalyzer {
public:

  /// Constructor
  SeedParametrization(const edm::ParameterSet& pset);

  /// Destructor
  virtual ~SeedParametrization();
