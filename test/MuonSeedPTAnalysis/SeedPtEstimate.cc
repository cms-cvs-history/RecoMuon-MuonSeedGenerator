// Class Header
#include "RecoMuon/SeedGenerator/test/MuonSeedPTAnalysis/SeedPtEstimate.h"
...
// constructors
SeedPtEstimate::SeedPtEstimate(const ParameterSet& pset){ 
...
// The Main
void SeedPtEstimate::analyze(const Event& event, const EventSetup& eSetup)
{
...
bool SeedPtEstimate::cscSimMatch(const edm::Handle<edm::PSimHitContainer> simHits , SegmentContainer CSClist0, int idx) {
...
DEFINE_FWK_MODULE(SeedPtEstimate);
