#ifndef RecoMuon_SeedPtEstimate_H
#define RecoMuon_SeedPtEstimate_H
...
class SeedPtEstimate: public edm::EDAnalyzer {
 ...
 public:
  ...
  /// Constructor
  SeedPtEstimate(const edm::ParameterSet& pset);

  /// Destructor
  virtual ~SeedPtEstimate();
