...
mkdir h_pt5to200
echo 'block ptSeedParameterization = {' > h_pt5to200/ptSeedParameterization.cfi
echo '# DT Parameters ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# Det_Stations          p1        p2        p3       ep1      ep2      ep3' >> h_pt5to200/ptSeedParameterization.cfi
echo '#------------------------------------------------------------------------#'>> h_pt5to200/ptSeedParameterization.cfi
...
echo '  ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# CSC Parameters ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# Det_Stations      p1        p2        p3       ep1      ep2      ep3' >> h_pt5to200/ptSeedParameterization.cfi
echo '#------------------------------------------------------------------------#'>> h_pt5to200/ptSeedParameterization.cfi
...
echo '  ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# OL Parameters ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# Det_Layers        p1        p2        p3       ep1      ep2      ep3' >> h_pt5to200/ptSeedParameterization.cfi
echo '#------------------------------------------------------------------------#'>> h_pt5to200/ptSeedParameterization.cfi
...
echo '# Sigle CSC Segments ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# CSCDet_Id         p1        p2        p3       ep1      ep2      ep3' >> h_pt5to200/ptSeedParameterization.cfi
echo '#------------------------------------------------------------------------#'>> h_pt5to200/ptSeedParameterization.cfi
...
echo '# Sigle DT Segments ' >> h_pt5to200/ptSeedParameterization.cfi
echo '# DTDet_Id          p1        p2        p3       ep1      ep2      ep3' >> h_pt5to200/ptSeedParameterization.cfi
echo '#------------------------------------------------------------------------#'>> h_pt5to200/ptSeedParameterization.cfi
